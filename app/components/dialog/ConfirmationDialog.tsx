    ...
    >
      <div className="modal-box">
        ...
        <div className="modal-action">
          <button
            className="btn btn-sm h-10 w-[90px] rounded-lg font-normal text-primary-content"
            onClick={() => setIsAttached(false)}
          >
            Cancel
          </button>
          <Form action={action} {...{ method }}>
            <button className="btn btn-error btn-sm h-10 w-[90px] rounded-lg font-normal text-primary-content">
              {button}
            </button>
          </Form>
        </div>
